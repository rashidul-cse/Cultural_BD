...
<html>
	...
	<body>
		<div class="main">
			...
			<div id="cpathway">
			<marquee>Overview of culture of Bangladesh ... </marquee>
			</div>
		...
		<div class="menu">	
			...
			<div class="maincontent">
				<div class="about">
					<h2>Overview of Culture:</h2>
					<div id=""><p><?php require("php/aboutCulturedes.php"); ?> </p></div>
					<div id="culture_2"><img src="images/pages/aculture.jpg" title="Baul Sangeet" /></div>
					<div id="culture_3"><p><?php require("php/aboutCulturedes_2.php"); ?> </p></div>
					<div id=""><p><?php require("php/aboutCulturedes_3.php"); ?> </p></div>
