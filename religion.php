...
<html>
	...
	<body>
		<div class="main">
			...
			<div id="cpathway">
			<marquee>Various Religions of Bangladesh ... </marquee>
			</div>
		...
		<div class="menu">	
			...
			<div class="maincontent">
				<div class="about">
					...
					<p><?php require("php/religiondes.php"); ?> </p>
					<img src="images/pages/r2.jpg" title="Mosque"/>
					<img src="images/pages/r1.jpg" title="Temple"/>
					<img src="images/pages/r3.jpg" title="Pagoda"/>
					<img src="images/pages/r4.jpg" title="Girza"/>
					<p><?php require("php/religiondes2.php"); ?> </p>
