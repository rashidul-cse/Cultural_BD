...
<html>
	...
	<body>
		<div class="main">
			...
			<div id="cpathway">
			<marquee>Literature of Bangladesh ... </marquee>
			</div>
		...
		<div class="menu">	
			...
			<div class="maincontent">
				<div class="about">
					...
					<p><?php require("php/literaturedes.php"); ?> </p>
					<img src="images/pages/kazi.jpg" title="Kazi Nazrul Islam"/>
					<img src="images/pages/tagore.jpg" title="Rabindra Nath Tagore"/>
					<img src="images/pages/ravi.jpg" title="Ravi Sankar"/>
					<img src="images/pages/kirton.jpg" title="SriKrishna Kirtan"/>
					<img src="images/pages/jibon.jpg" title="Jibonanonda Das"/>
					<img src="images/pages/zahir.jpg" title="Zahir Raihan"/>
					<p><?php require("php/literaturedes2.php"); ?> </p>
				</div>
			</div>
