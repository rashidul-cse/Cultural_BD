...
<html>
	...
	<body>
		<div class="main">
			...
			<div id="cpathway">
			<marquee>Sports of Bangladesh ... </marquee>
			</div>
		...
		<div class="menu">	
				...
				<ul> 
						...
						<li> <a target="" href="Culture.php">Cultures</a> 
								<ul>
									...
									<li><a target="" href="festival.php">Festival</a></li>
			...
			<div class="maincontent">
				<div class="about">
					...
					<p><?php require("php/sportsdes.php"); ?> </p>
					<img src="images/pages/s1.jpg" title="Football"/>
					<img src="images/pages/s2.jpg" title="Cricket"/>
					<img src="images/pages/s3.jpg" title="Darshok in Cricket"/>
					<img src="images/pages/s4.jpg" title="Golfer Siddiqur"/>
					<img src="images/pages/s5.jpg" title="NoukaBice"/>
					<img src="images/pages/s6.jpg" title="Ha-du-du"/>
					<p><?php require("php/sportsdes2.php"); ?> </p>
					<img src="images/pages/s7.jpg" title="Dour Khela"/>
					<img src="images/pages/s8.jpg" title="Women's Football"/>
					<img src="images/pages/s9.jpg" title="Various Sports"/>
					<img src="images/pages/s10.jpg" title="GollaChut"/>
					<img src="images/pages/s11.jpg" title="KanaMachi"/>
					<img src="images/pages/s12.jpg" title="Darshok in Cricket"/>
					<p><?php require("php/sportsdes3.php"); ?> </p>
