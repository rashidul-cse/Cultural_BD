...
<html>
	...
	<body>
		<div class="main">
			...
			<div id="cpathway">
			<marquee>About Media of Bangladesh ... </marquee>
			</div>
		...
		<div class="menu">	
			...
			<div class="maincontent">
				<div class="about">
					...
					<p><?php require("php/mediades.php"); ?> </p>
					<img src="images/pages/t.jpg" title="Media of Bangladesh"/>
					<p><?php require("php/mediades2.php"); ?> </p>
