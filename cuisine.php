...
<html>
	...
	<body>
		<div class="main">
			...
			<div id="cpathway">
			<marquee>About Cuisine of Bangladesh ... </marquee>
			</div>
		...
		<div class="menu">	
			...
			<div class="maincontent">
				<div class="about">
					...
					<p><?php require("php/cuisinedes.php"); ?> </p>
					<img src="images/pages/c1.jpg" title="Sarshe Ilish"/>
					<img src="images/pages/c2.jpg" title="Chingri"/>
					<img src="images/pages/c3.jpg" title="A piece of fish"/>
					<img src="images/pages/c4.jpg" title="Patishapta Pitha"/>
					<img src="images/pages/c5.jpg" title="Meal in Kala Pata"/>
					<img src="images/pages/c6.jpg" title="Sweet"/>
					<p><?php require("php/cuisinedes2.php"); ?> </p>
					<img src="images/pages/c7.jpg" title="Vegetables"/>
					<img src="images/pages/c8.jpg" title="Murgi Vuna"/>
					<img src="images/pages/c9.jpg" title="Murgi jhalfry"/>
					<img src="images/pages/c10.jpg" title="Vegetables"/>
					<img src="images/pages/c11.jpg" title="Alu Vorta"/>
					<img src="images/pages/c12.jpg" title="Mixed Meal"/>
					<p><?php require("php/cuisinedes3.php"); ?> </p>
				</div>
			</div>
