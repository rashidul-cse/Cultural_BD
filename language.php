...
<html>
	...
	<body>
		<div class="main">
			...
			<div id="cpathway">
			<marquee>About Language of Bangladesh ... </marquee>
			</div>
		...
		<div class="menu">	
			...
			<div class="maincontent">
				<div class="about">
					<h2>Languages of Bangladesh:</h2>
					<div id="lan1"><?php require("php/languagedes.php"); ?> </div>
					<div id="lan2"><img src="images/pages/lang.png" title="Language of Bangladesh"></div>
					<div id="lan3"><?php require("php/languagedes2.php"); ?> </div>
					<div id="lan4"><?php require("php/languagedes3.php"); ?> </div>
				</div>
			</div>
