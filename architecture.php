...
<html>
	...
	<body>
		<div class="main">
			...
			<div id="cpathway">
			<marquee>Creative Architectures of Bangladesh ... </marquee>
			</div>
		...
		<div class="menu">	
			...
			<div class="maincontent">
				<div class="about">
					...
					<p><?php require("php/architecturedes.php"); ?> </p>
					<img src="images/pages/t1.jpg" title="Karjan Hall"/>
					<img src="images/pages/t2.jpg" title="A Mosque in Dhaka"/>
					<img src="images/pages/t3.jpg" title="Puthiya Rajbari"/>
					<img src="images/pages/t4.jpg" title="Sangsad Bhavan"/>
					<img src="images/pages/t6.jpg" title="Shat Gambuj Mosque"/>
					<img src="images/pages/t5.jpg" title="A Mosque in Dhaka"/>
					<p><?php require("php/architecturedes2.php"); ?> </p>
				</div>
			</div>
