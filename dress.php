...
<html>
	...
	<body>
		<div class="main">
			...
			<div id="cpathway">
			<marquee>Traditional dresses of Bangladesh ... </marquee>
			</div>
		...
		<div class="menu">	
			...
			<div class="maincontent">
				<div class="about">
					...
					<p><?php require("php/dressdes.php"); ?> </p>
					<div id=""><img src="images/pages/dhuti.jpg" title="Dhuti & Panjabi" /></div>
					<div id="d2"><img src="images/pages/lungi.jpg" title="Shari"/></div>
					<div id="d3"><img src="images/pages/fotua.jpg" title="Pajama & Panjabi"/></div>
					<p><?php require("php/dressdes2.php"); ?> </p>
