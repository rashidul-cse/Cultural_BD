...
<html>
	...
	<body>
		<div class="main">
			...
			<div id="cpathway">
			<marquee>Art and Music of Bangladesh ... </marquee>
			</div>
		...
		<div class="menu">	
			...
			<div class="maincontent">
				<div class="about">
					...
					<p><?php require("php/artdes.php"); ?> </p>
					<img src="images/pages/a1.jpg" title="Karu Shilpa"/>
					<img src="images/pages/a2.jpg" title="Mrit Shilpa"/>
					<img src="images/pages/a3.jpg" title="jol Rang"/>
					<img src="images/pages/a4.jpg" title="Art Gallery"/>
					<img src="images/pages/a6.jpg" title="Singer Bappa Majumdar"/>
					<img src="images/pages/a5.jpg" title="Setara & Tabla"/>
					<p><?php require("php/artdes2.php"); ?> </p>
				</div>
			</div>
