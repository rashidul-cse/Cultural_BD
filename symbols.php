...
<html>
	...
	<body>
		<div class="main">
			...
			<div id="cpathway">
			<marquee>Various Symbols of Bangladesh ... </marquee>
			</div>
		...
		<div class="menu">	
			...
			<div class="maincontent">
				<div class="about">
					...
					<p><?php require("php/symbolsdes.php"); ?> </p>
					<img src="images/pages/e1.jpg" title="National Symbols"/>
					<p><?php require("php/symbolsdes2.php"); ?> </p>
				</div>
			</div>
