...
<html>
	...
	<body>
		<div class="main">
			...
			<div id="cpathway">
			<marquee>Behind this website of culture of Bangladesh ... </marquee>
			</div>
		...
		<div class="menu">	
			...
			<div class="maincontent">
				<div class="about">
					<h3>Behind This Website:</h3>
					<div id="first_p"><?php require("php/home.php"); ?></div>
					<div id="second_p"><img src="images/pages/home.jpg" title="At a Pahela Baishakh"></div>
					<div id="third_p"><?php require("php/home_2.php"); ?> </div>
					<div id="fourth_p"><?php require("php/home_3.php"); ?> </div>
				</div>
			</div>
