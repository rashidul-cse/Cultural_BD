...
<html>
	...
	<body>
		<div class="main">
			...
			<div id="cpathway">
			<marquee>Portals of Bangladesh ... </marquee>
			</div>
		...
		<div class="menu">	
			...
			<div class="maincontent">
				<div class="about">
					...
					<p><?php require("php/portaldes.php"); ?> </p>
					<img src="images/pages/p.jpg" title="News Portals of Bangladesh"/>
					<p><?php require("php/portaldes2.php"); ?> </p>
				</div>
			</div>
